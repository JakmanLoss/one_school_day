...
'''for i in range(len(school_class) - 1):
    if (school_class[i] % ch_poz == 0 and school_class[i + 1] % ch_poz != 0) or (school_class[i + 1] % ch_poz == 0 and school_class[i] % ch_poz != 0):
        kc += 1'''
...
'''for i in range(len(school_class) - 1):
    if (school_class[i] % nc_poz == 0 and school_class[i + 1] % nc_poz != 0) or (school_class[i + 1] % nc_poz == 0 and school_class[i] % nc_poz != 0):
        kc += 1'''
#альтернативное нахождение пар
print(kc, kn)